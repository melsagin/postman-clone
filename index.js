console.log('Postman Clone Hizmete Açıktır.'); //ctrl-shift-j ile consolda içeride yazan ifade görüntülenir.
...
function copy() { //copy fonksiyonu JSONresponse'u seçtiğinde copyalama işlemini yapacaktir.
